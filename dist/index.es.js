...
var Wrapper = styled.div.withConfig({
  ...
  return props.disabled && css(["border:solid 1px #707070;background-color:#e8e9e9;"]);
...
var DeleteButton$1 = styled.div.withConfig({
...
var FileSquare = styled.div.withConfig({
...
var NotImage$1 = styled.div.withConfig({
...
var PreviewMultiFile = function PreviewMultiFile(_ref) {
  ...
  if (files) return /*#__PURE__*/React.createElement(React.Fragment, null, (files === null || files === void 0 ? void 0 : files.length) > 0 && files.map(function (file, i) {
    return /*#__PURE__*/React.createElement(FileWrapper, {
      key: i
    }, /*#__PURE__*/React.createElement(FileSquare, null, file.type.split('/')[0] === 'image' ?
    /*#__PURE__*/
    ...
    React.createElement(NotImage$1, null, /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement(FontAwesomeIcon, {
      icon: faPaperclip
    }), " attachment"), /*#__PURE__*/React.createElement("p", null, file === null || file === void 0 ? void 0 : file.name), /*#__PURE__*/React.createElement("p", null, formatBytes(file === null || file === void 0 ? void 0 : file.size))), /*#__PURE__*/React.createElement(DeleteButton$1, null, /*#__PURE__*/React.createElement(FontAwesomeIcon, {
      icon: faTrash,
...
var DeleteButton = styled.div.withConfig({
  displayName: "DeleteButton",
...
var VideoDescription = styled.div.withConfig({
...
var NotImage = styled.div.withConfig({
  displayName: "NotImage",
...
var DeleteFileButton = styled.div.withConfig({
...
var PreviewSingleFile = function PreviewSingleFile(_ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, files.map(function (file, i) {
    return /*#__PURE__*/React.createElement(React.Fragment, {
      key: i
    }, file.type.split('/')[0] === 'image' ?
    /*#__PURE__*/
    // kalau dia berbentuk image, maka akan tampil ini
    React.createElement(ImageWrapper, null, /*#__PURE__*/React.createElement("img", {
      src: URL.createObjectURL(file),
      alt: file.name,
      width: "100%",
      height: "100%"
    }), /*#__PURE__*/React.createElement(DeleteButton, null, /*#__PURE__*/React.createElement(FontAwesomeIcon, {
      icon: faTrash,
      onClick: function onClick() {
        handleDelete(i);
      }
    ...
    React.createElement(VideoWrapper, null, /*#__PURE__*/React.createElement("video", {
      width: "100%",
      controls: true
    }, /*#__PURE__*/React.createElement("source", {
      src: URL.createObjectURL(file),
      type: "video/mp4"
    })), /*#__PURE__*/React.createElement(VideoDescription, null, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", null, file === null || file === void 0 ? void 0 : file.name), /*#__PURE__*/React.createElement("p", null, formatBytes(file === null || file === void 0 ? void 0 : file.size))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(DeleteFileButton, null, /*#__PURE__*/React.createElement("p", {
      onClick: function onClick() {
        handleDelete(i);
      }
    ...
    /*#__PURE__*/
    // selain image, hanya berbentuk kotak berisi info nama file dan ukuran
    React.createElement(NotImage, null, /*#__PURE__*/React.createElement("p", null, file === null || file === void 0 ? void 0 : file.name), /*#__PURE__*/React.createElement("p", null, formatBytes(file === null || file === void 0 ? void 0 : file.size)), /*#__PURE__*/React.createElement(DeleteFileButton, null, /*#__PURE__*/React.createElement("p", {
      onClick: function onClick() {
        handleDelete(i);
      }
    }, /*#__PURE__*/React.createElement(FontAwesomeIcon, {
...
var FileUpload = function FileUpload(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Wrapper, null, label && /*#__PURE__*/React.createElement("label", {
    ...
    className: "d-flex"
  }, /*#__PURE__*/React.createElement("h4", null, label, props.mandatory && /*#__PURE__*/React.createElement("span", {
    className: "mandatory"
    ...
    return /*#__PURE__*/React.createElement(UploadWrapper, null, !disablePreview && /*#__PURE__*/React.createElement(React.Fragment, null, maxFiles === 1 && (files === null || files === void 0 ? void 0 : files.length) > 0 ? /*#__PURE__*/React.createElement(PreviewSingleFile, {
      files: files,
      deleteFile: handleDelete
    }) : /*#__PURE__*/React.createElement(PreviewMultiFile, {
      files: files,
      deleteFile: handleDelete
    })), maxFiles === 1 && files.length > 0 ? null : /*#__PURE__*/React.createElement("div", getRootProps({
